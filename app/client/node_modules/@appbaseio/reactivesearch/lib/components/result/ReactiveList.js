...
var ReactiveList = function (_Component) {
	...
	ReactiveList.prototype.componentDidMount = function componentDidMount() {
		...
		if (this.props.sortOptions) {
			...
			this.props.updateComponentProps(this.props.componentId, _extends({}, this.props, { dataField: sortField, sortBy: sortBy }), _constants.componentTypes.reactiveList);
...
var _initialiseProps = function _initialiseProps() {
	...
	this.handleSortChange = function (e) {
		...
		_this3.props.updateComponentProps(_this3.props.componentId, _extends({}, _this3.props, { dataField: sortField, sortBy: sortBy }), _constants.componentTypes.reactiveList);
...
var ConnectedComponent = (0, _utils.connect)(mapStateToProps, mapDispatchtoProps)((0, _emotionTheming.withTheme)(function (props) {
	return (0, _core.jsx)(
		...
		function () {
			return (0, _core.jsx)(ReactiveList, _extends({ ref: props.myForwardedRef }, props));
		}
	);
}));
